...
import { CONNECTION_DBID_MESSAGE_REQ, CONNECTION_DBID_REQ, CONNECTION_DBNAME_MESSAGE_REQ, CONNECTION_DBNAME__REQ, CONNECTION_DB_REQ, CONNECTION_FILE_REQ, CONNECTION_ID_MESSAGE_REQ, CONNECTION_ID_REQ,  CONNECTION_MESSAGE_REQ, CONNECTION_NAME_MESSAGE_REQ, CONNECTION_NAME_REQ, CONNECTION_TEST_REQ, CRON_VALUE_REQ,DAGCREATE_DBMSTYPE_REQ,DAGCREATE_SAVEMODE_REQ,DAGCREATE_TARGETCONNID_REQ,DAGCREATE_TARGETLOCATION_REQ,DAGCREATE_TRANSTYPE_REQ,FILE_TYPE_LIST_REQ,FLOW_FILENAME_REQ,FLOW_ISPAUSED_REQ,LIST_DAG_REQ, LIST_DAG_RES, LOG_DAGRUNID_REQ, LOG_FLOW_ID, LOG_SENSORID_REQ,  LOG_TASK_REQ, LOG_TRYNUMBER_REQ, PATH_MESSAGE_REQ, PATH_VALUE_REQ, POST_DAGRUN_REQ, POST_DAGRUN_RES,  SENSOR_ID_REQ, SFTPCONNECTION_MESSAGE_REQ, SFTPCONNECTION_REQ, SFTP_RESULT_MSG_REQ, SOURCEID_REQ, SOURCENAME_CHECK_REQ, SOURCE_DBMSTYPE_REQ, SOURCE_DB_CONNECTION_ID, SOURCE_DB_CONNID_REQ, SOURCE_DETAIL_REQ, SOURCE_ID_REQ, SOURCE_LOCALPATH_REQ, SOURCE_NAME_REQ, TARGETCONID_REQ, TARGETID_REQ, TARGETNAMEVALUE_REQ, TARGETNAME_CHECK_REQ, TARGETNAME_REQ, TARGET_CONNID_REQ, TARGET_ID_REQ, TARGET_LOCATION_REQ, TARGET_NAME_REQ, TARGET_SAVEMODE_REQ, TASK_SENSORID_REQ, TEST_ASYNC_REQ, TEST_ASYNC_RES } from "./constants";
...
type source_connection_id_db = {
  source_connection_id_db : any;
}
