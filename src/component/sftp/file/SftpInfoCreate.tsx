...
import { connectionID_Message_REQ, connectionID_REQ, connectionNAME_Message_REQ, connectionNAME_REQ } from '../../../redux/actions/creatorActions';
        ...
        <div className='w-100'>
            ...
            <div className='row mb-12'>
                ...
                <div className='col-md-6 fv-row'>
                    ...
                    <div className='form-control form-control-solid' placeholder=''>
                        {
                            idValue === "" ? <span className='text-danger'>SFTP커넥션 아이디를 입력해주세요.</span> : checkMessageID === "가능" ? <span className='text-success'>{checkMessageName} 커넥션 이름 입니다.</span> : <span className='text-danger'>{checkMessageName} 커넥션 이름 입니다.</span>
                        }
                    </div>
                </div>
            </div>
            <div className='row mb-12'>
                ...
                <div className='col-md-6 fv-row'>
                    ...
                    <div className='form-control form-control-solid' placeholder=''>
                        {
                            nameValue === "" ? <span className='text-danger'>SFTP커넥션 이름을 입력해주세요.</span> : checkMessageName === "가능" ? <span className='text-success'>{checkMessageName} 커넥션 이름 입니다.</span> : <span className='text-danger'>{checkMessageName} 커넥션 이름 입니다.</span>
