    ...
    <div className='w-100'>
      ...
      <div className='row mb-12'>
        ...
        <div className='col-md-6 fv-row'>
          ...
          <div className='position-relative'>
            {status === '0000' ? (
              <div className='btn btn-lg btn-light-success me-3'>{connectionMessage}</div>
            ) : (
              <div className='btn btn-lg btn-light-danger me-3'>{connectionMessage}</div>
            )}
          </div>
        </div>
      </div>
