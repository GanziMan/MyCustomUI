...
const DBConList: React.FC<Props> = ({className}, {ConnectionList}:ConnectionProps) => {
  const [data, setData] = useState([]);
  useEffect(() => {
    customAxios.get(`connection/find-db`)
    ...
    <div className={`card ${className}`}>
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>DB Connection List</span>
