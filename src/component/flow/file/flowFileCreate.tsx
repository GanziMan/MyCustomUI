...
const FlowFileCreate: FC = () => {
  ...
  useEffect(() => {
    if (fileTypeValue !== '') {
      customAxiosConnection.get(`local-path?path=${local_path}`).then(function (response) {
    ...
    <div className='w-100'>
      ...
      <div className='row mb-12'>
        <div className='col-md-6 fv-row'>
          ...
          <div className='position-relative'>
            <Field type='text' name='delimiter' className='form-control form-control-solid'></Field>
          </div>
        </div>
