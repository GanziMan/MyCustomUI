...
import { dagcreateSAVEMODE_REQ, dagcreateTARGETCONNID_REQ, dagcreateTargetLocation_REQ, target_id_REQ } from '../../../redux/actions/creatorActions';
                                                ...
                                                {dbselect && dbselect?.map((flow: any) => {
                                                    {
                                                        ...
                                                        if (flow.source_name === dbConnection) {
                                                            ...
                                                            return (<div key={flow.id}>{flow.id}</div>)
                                                        }
                                                    }
                                                })}
                                            </div>
                                                    ...
                                                    {dbselect && dbselect?.map((flow: any) => {
                                                        { 
                                                                if (flow.target_name === dbConnection) {
                                                                    dispatch(target_id_REQ(flow.id));
                                                                    dispatch(dagcreateSAVEMODE_REQ(flow.save_mode));
                                                                    dispatch(dagcreateTARGETCONNID_REQ(flow.target_conn_id.connection_id));
