...
const FlowDbhorizon: FC = () => {
  ...
  const confFile = {
    params: {
      ...
      db_conn_id: '',
      partition_size: initValues.partition_size,
      dbms_type: initValues.dbms_type,
      engine_code_file_name: initValues.engine_code_file_name,
      db_read_table_name: initValues.db_read_table_name,
      db_sql: initValues.db_sql,
