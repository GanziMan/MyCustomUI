...
const FlowDBCreate: FC = () => {
    ...
    useEffect(()=>{
        customAxios.get(`duplicateCheck?type=dag_name&value=${sourceName}`)
            ...
            <div className='row mb-12'>
                ...
                <label className='d-flex align-items-center fs-6 fw-bold form-label mb-2'>
                    ...
                    <div className='form-control form-control-solid' placeholder=''>
                        {
                            dagCheckMessage === "가능" ? <span className='text-success'>{dagCheckMessage} Dag 이름 입니다.</span> : <span className='text-danger'>{dagCheckMessage} Dag 이름 입니다.</span>
                        }
                    </div>
                </div>
            </div>
