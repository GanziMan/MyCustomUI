...
import { log_dagrunid_REQ, log_sensorid_REQ, log_taskid_REQ, log_tryNumber } from '../../redux/actions/creatorActions';
...
const TaskList: FC = () => {
    ...
    useEffect(() => {
        customAxiosAirflow.get(`get?dags=dags/${sensor_id}/dagRuns/${dag_id}/taskInstances`)
                    ...
                    <div className='card card-xl-stretch mb-5 mb-xl-8'>
                        ...
                        <h3 className='card-title fw-bold text-success'>{tasks1} Details</h3>
                            <div className='card-toolbar'>
                                <div onClick={LogTask1}><LogModal></LogModal></div>
                            </div>
                        </div>
                ...
                <div className='col-xl-4'>
                    <div className='card card-xl-stretch mb-5 mb-xl-8'>
                        ...
                        <h3 className='card-title fw-bold text-success'>{tasks2} Details</h3>
                            <div className='card-toolbar'>
                                <div onClick={LogTask2}><LogModal></LogModal></div>
                            </div>
                        </div>
                        <div className='card-body pt-0'>
                            <div className='d-flex align-items-center bg-light-success rounded p-5'>
                ...
                <div className='col-xl-4'>
                    <div className='card card-xl-stretch mb-5 mb-xl-8'>
                        <div className='card-header border-0'>
                            ...
                            <div className='card-toolbar'>
                                <div onClick={LogTask3}><LogModal></LogModal></div>
                            </div>
                        </div>
                        <div className='card-body pt-0'>
                            <div className='d-flex align-items-center bg-light-success rounded p-5'>
