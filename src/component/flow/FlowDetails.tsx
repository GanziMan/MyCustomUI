...
export function FlowDetails() {
    ...
    useEffect(() => {
        customAxios.get(`flow/find-by-dag-name?id=${ID}`)
            ...
            customAxiosAirflow.get(`get?dags=dags/${sensor_id}`)
            .then(function (response) {
    ...
    const DagRunFile = async () => {
        ...
        await customAxiosAirflow.post(`post`, { dags })
            .then(function (response) {
                toast.info(`${sensorID} DagRun 실행 하였습니다. 잠시 후 변동이 없다면 다시한번 실행하여주세요. \n잠시만 기다려주세요.`);
                navigate("/dashboard")
            })
    }
    const DagRunDB = () => {
    ...
    const Delete = () => {
        if (window.confirm("정말 삭제합니까?")) {
            customAxiosAirflow.delete(`delete?dags=dags/${sensorID}`)
                .then(function (response) {
                    customAxios.delete(`flow/delete?id=${id}`)
                        .then(function (response) {
                            navigate("/dashboard");
    ...
    const ActiveTrue = () => {
        customAxiosAirflow.patch("patch",{dags: `dags/${sensorID}`,is_paused:true})
        .then(function(response){
            ...
            <div className='card mb-5 mb-xl-10' id='kt_profile_details_view'>
                <div className='card-header cursor-pointer'>
                    ...
                    <div className='card-toolbar'>
                        ...
                        >
                            ...
                            <div className='menu-item px-3'>
                                {
                                    dbms_type === null ? <a href='#' className='menu-link px-3' onClick={DagRunFile}>
                                        FilE Dag Run
                                    </a> : <a href='#' className='menu-link px-3' onClick={DagRunDB}>
                                        DB Dag Run
                                    </a>
                                }
                            </div>
                ...
                <div className='card-body p-9'>
                   ...
                   <div className='row mb-10'>
                    ...
                    {
                        dataType !== null ? <div className='row mb-10'>
                            <label className='col-lg-4 fw-bold text-muted'>데이터 타입</label>

                            <div className='col-lg-8'>
                                {
                                    dataType === "structed" ? <span className='fw-bold fs-6'>정형 데이터</span> : <span className='fw-bold fs-6'>비정형 데이터</span>
                                }
                    ...
                    {
                        db_read_table_name !== null ? <div className='row mb-10'>
                    ...
                    {
                        engine_code_file_name !== null ? <div className='row mb-10'>
                            <label className='col-lg-4 fw-bold text-muted'>파일 이름</label>
                    ...
                    {
                        partition_size !== null ? <div className='row mb-10'>
                    ...
                    {
                        trans_type !== null ? <div className='row mb-10'>
                    ...
                    {
                        saveMode !== null ? <div className='row mb-10'>
                    ...
                    {
                        localPath !== null ? <div className='row mb-10'>
                    ...
                    {
                        targetLocation !== null ? <div className='row mb-10'>
                    ...
                    <div className='row mb-10'>
                        ...
                        {
                            is_paused === false ? <> <div className='col-lg-8'>
                                <span className='fw-bold fs-6'>  <a className='btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3'>ON</a></span>
                            </div></> : <> <div className='col-lg-8'>
                                <span className='fw-bold fs-6'>  <a href='#'className='btn btn-sm btn-light-secondary fw-bolder ms-2 fs-8 py-1 px-3'>
                                    OFF
                                </a></span>
                            </div></>
                        }
