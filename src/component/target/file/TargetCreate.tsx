...
const TargetCreate: FC = () => {
    ...
    useEffect(() => {
        customAxios.get(`target/duplicateCheck?value=${nameValue}`)
            ...
            <div className='row mb-12'>
                ...
                <div className='col-md-6 fv-row'>
                    ...
                    <div className='form-control form-control-solid' placeholder=''>
                        {
                            message === "가능" ? <span className='text-success'>{message} Target 이름 입니다.</span> : <span className='text-danger'>{message} Target 이름 입니다.</span>
                        }
                    </div>
                </div>
