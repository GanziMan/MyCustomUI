...
const TargetUpdate: FC = () => {
    ...
    const prevTarget_location = useSelector((state:RootState) => state.cronreducer.update_target_location);
    ...
    const prevTarget_connid = useSelector((state:RootState) => state.cronreducer.update_target_connid);
    ...
    const Update = () => {
        ...
        {
            customAxios.patch("target/update", {id:prevTarget_id, target_name: target_name, target_location: target_location , save_mode:save_mode, target_conn_id:{id:prevTarget_connid}})
