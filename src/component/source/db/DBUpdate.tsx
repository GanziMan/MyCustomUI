...
const DBUpdate: FC = () => {
  ...
  const prevSource_name = useSelector(
    (state: RootState) => state.sourcedetailreducer.state.source_name
  )
  ...
  const db_conn_id = useSelector(
    (state: RootState) => state.sourcedetailreducer.state.db_conn_id.id
  )
