...
export function SourceDetails() {
  ...
  useEffect(() => {
    customAxios
      .get(`source/find-by-source-name?id=${state}`)
            ...
            >
              ...
              {trans_type === 'FILE' ? (
                <div
                  ...
                  onClick={() => {
                    navigate('/sourcefileupdate', {state: source_name})
                  }}
                >
                ...
                <div
                  className='menu-item px-3'
                  onClick={() => {
                    navigate('/sourcedbupdate', {state: source_name})
                  }}
                >
                  <a href='#' className='menu-link px-3'>
                    Update
        ...
        <div className='card-body p-9'>
          ...
          <div className='row mb-7'>
            ...
            <div className='col-lg-8'>
              {trans_type === 'FILE' ? (
                <span className='fw-bolder fs-6 text-dark'>{local_path}</span>
              ) : (
                <span className='fw-bolder fs-6 text-danger'>( ※ DB 수집 소스입니다. )</span>
              )}
            </div>
          </div>
          ...
          <div className='row mb-10'>
            ...
            <div className='col-lg-8'>
              {trans_type === 'FILE' ? (
                <span className='fw-bold text-danger fs-6'>( ※ FILE 수집 소스입니다. )</span>
              ) : (
                <span className='fw-bold fs-6'>{dbms_type}</span>
              )}
            </div>
          </div>
        </div>
