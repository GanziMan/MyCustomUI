            ...
            <div className='card-body py-3'>
                <div className='table-responsive'>
                    <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3'>
                        ...
                        <tbody>
                            {
                                placeList && placeList.map((place, i: number) => (
                                    <tr key={i}>
                                        <td>
                                            <div className='form-check form-check-sm form-check-custom form-check-solid'>
                                        ...
                                        <td>
                                            {
                                                place.trans_type === "FILE" ?  <a href='#' className='text-dark fw-bold text-hover-success d-block mb-1 fs-6'>
                                                {place.local_path} 
                                            </a> : <a href='#' className='text-danger fw-bold text-hover-danger d-block mb-1 fs-6'>
                                            ( ※ 전송방식이 FILE인 소스 입니다.)
                                            </a>
                                            }
                                        ...
                                        {
                                            place.trans_type === "FILE" ? <td className='text-danger fw-bold text-hover-danger fs-6'> ( ※ 전송방식이 FILE인 소스 입니다.) </td> : <td className='text-dark fw-bold text-hover-success fs-6'> {place.dbms_type}</td>
                                        }
                                        
                                        <td>
                                        <button type='button' className='btn btn-lg btn-success me-3' onClick={() => navigate("/sourcedetails",{state:place.source_name})}>
                                         상세보기
                                        </button>
                                        </td>
                                    </tr>
