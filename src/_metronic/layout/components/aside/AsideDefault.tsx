    ...
    >
      ...
      <div className='aside-primary d-flex flex-column align-items-lg-center flex-row-auto'>
        ...
        <div
          ...
          id='kt_aside_logo'
        >
          <Link to='/dashboard' onClick={ReloadClick}>
            <img src={toAbsoluteUrl('/media/logos/default.svg')} alt='logo' className='h-10px' />
          </Link>
        </div>
        {/* end::Logo */}
        {/* begin::Nav */}
      ...
      {config.aside.secondaryDisplay && (
        <>
          ...
          <button
            id='kt_aside_toggle'
            className={clsx(
              'btn btn-sm btn-icon bg-body btn-color-gray-700 btn-active-success position-absolute translate-middle start-100 end-0 bottom-0 shadow-sm d-none d-lg-flex',
