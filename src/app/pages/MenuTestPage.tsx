      ...
      <div className='card card-custom'>
        <div className='card-body p-9'>
          <div className='d-flex align-items-stretch mb-20'>
            ...
            >
              <div
                className='menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-success menu-state-icon-success menu-state-bullet-success menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch'
                id='#kt_header_menu'
                data-kt-menu='true'
              >
          ...
          <div className='mb-20 w-200px'>
            <div
              ...
              data-kt-menu-placement='bottom-start'
            >
              <div className='btn btn-icon btn-active-light-success w-30px h-30px w-lg-40px h-lg-40px'>
            ...
            >
              ...
              >
                <div className='position-relative'>
                  ...
                  <span
                    className='btn btn-flush btn-active-color-success position-absolute top-50 end-0 translate-middle-y lh-0 d-none'
          ...
          <div className='w-250px bg-light rounded py-5'>
            <div
              className='menu menu-column menu-title-gray-700 menu-state-title-success menu-state-icon-success menu-state-bullet-success menu-arrow-gray-500'
              id='#kt_aside_menu'
              data-kt-menu='true'
            >
              <div className='menu-item'>
              ...
              <div data-kt-menu-trigger='click' className='menu-item'>
                ...
                <div className='menu-sub menu-sub-accordion menu-active-bg'>
                  ...
                  >
                    ...
                    <div className='menu-sub menu-sub-dropdown w-200px menu-active-bg menu-title-gray-700 menu-state-title-success menu-state-icon-success menu-state-bullet-success menu-arrow-gray-500'>
                      <div className='menu-item'>
                        <a
                          className='menu-link'
                          href='/keenthemes/products/themes/start/html/demo1/dist/?page=pages/profile/overview'
