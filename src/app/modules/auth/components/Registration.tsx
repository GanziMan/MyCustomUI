  ...
  return (
    ...
    >
      ...
      <div className='mb-10 text-center'>
        {/* begin::Title */}
        <h1 className='text-dark mb-3'>수집에이전트 관리자 계정 생성</h1>
        {/* end::Title */}

        {/* begin::Link */}
        <div className='text-gray-400 fw-bold fs-4'>
          이미 계정이 있으신가요 ?
          <Link to='/auth/login' className='link-success fw-bolder' style={{marginLeft: '5px'}}>
            비밀번호를 잊으셨나요 ?
          </Link>
        </div>
        {/* end::Link */}
      ...
      {/* begin::Action */}
      {/* <button type='button' className='btn btn-light-success fw-bolder w-100 mb-10'>
        <img
          alt='Logo'
      ...
      <div className='row fv-row mb-7'>
        <div className='col-xl-6'>
          <label className='class="form-label fw-bolder text-dark fs-6'>성</label>
          <input
