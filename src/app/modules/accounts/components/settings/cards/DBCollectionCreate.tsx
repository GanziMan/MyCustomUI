    ...
    {formik.touched.sensor_id && formik.errors.sensor_id && (
        <div className='fv-plugins-message-container'>
            <div className='fv-help-block'>{formik.errors.sensor_id}</div>
                        ...
                        <div className='row mb-6'>
                            <label className='col-lg-2 col-form-label required fw-bold fs-6'>engine_code_file_name</label>
                            <div className='col-lg-3 fv-row'>
                                <input
                                    type='text'
                                    className='form-control form-control-lg form-control-solid'
                        ...
                        <div className='row mb-6'>
                            <label className='col-lg-2 col-form-label required fw-bold fs-6'>db_partition_size</label>
                            <div className='col-lg-3 fv-row'>
                                <input
                                    type='text'
                                    className='form-control form-control-lg form-control-solid'
                            ...
                            <label className='col-lg-2 col-form-label required fw-bold fs-6'>db_read_table_name</label>
                            <div className='col-lg-3 fv-row'>
                                <input
                                    type='text'
                                    className='form-control form-control-lg form-control-solid'
